...
export interface CreateProductOpFacadeProdMgmtCreateProductPostRequest {
    productSchema: ProductSchema;
}
...
export class DefaultApi extends runtime.BaseAPI {
     ...
     * Create Product
     */
    async createProductOpFacadeProdMgmtCreateProductPostRaw(requestParameters: CreateProductOpFacadeProdMgmtCreateProductPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['productSchema'] == null) {
            throw new runtime.RequiredError(
                'productSchema',
                'Required parameter "productSchema" was null or undefined when calling createProductOpFacadeProdMgmtCreateProductPost().'
            );
        }
        ...
        const response = await this.request({
            path: `/op_facade/prodMgmt/CreateProduct`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: ProductSchemaToJSON(requestParameters['productSchema']),
     ...
     * Create Product
     */
    async createProductOpFacadeProdMgmtCreateProductPost(requestParameters: CreateProductOpFacadeProdMgmtCreateProductPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<any> {
        const response = await this.createProductOpFacadeProdMgmtCreateProductPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
